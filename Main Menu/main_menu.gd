extends Node
@onready var display_name = $CanvasLayer/Multiplayer/VBoxContainer/DisplayName
...
func _on_display_name_text_changed():
	print("setting diaply: ", display_name.text)
	Global.player_diplay = display_name.text
